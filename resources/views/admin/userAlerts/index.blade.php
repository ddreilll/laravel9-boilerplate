...
@section('content')
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-title mb-0 mt-1">{{ trans('cruds.userAlert.title_singular') }} {{ trans('global.list') }}</div>

            @can('user_alert_create')
                <a class="btn btn-primary float-right" href="{{ route('admin.user-alerts.create') }}">
                    <i class="fa-solid fa-plus mr-1"></i> {{ trans('global.add') }} {{ trans('cruds.userAlert.title_singular') }}
                </a>
            @endcan
        </div>
