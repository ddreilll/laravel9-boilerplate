            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('profile.password.updateProfile') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text"
                                disabled name="name" id="name" value="{{ old('name', auth()->user()->name) }}"
                                required>
                            @if ($errors->has('name'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" disabled
                    ...
                    <div class="alert alert-warning mt-4" role="alert">
                        <h4 class="alert-warningg"><i class="fa-solid fa-square-info mr-1"></i> {{ trans('global.note') }}</h4>
                        <p class="mb-0">{{ trans('panel.contact_profile_change') }}</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('profile.password.update') }}">
                        ...
                        <div class="form-group text-right">
                            <button class="btn btn-primary" type="submit">
                                <i class="fa-solid fa-floppy-disk mr-1"></i> {{ trans('global.save_changes') }}
                            </button>
                        </div>
                    </form>
                </div>
